{
  flake.nixosModules.thelessnas-backups =
    ...
    {
      systemd.services = {
        borgbackup-repo-postgres.unitConfig.RequiresMountsFor = "/moon";
        borgbackup-repo-hass.unitConfig.RequiresMountsFor = "/moon";
        borgbackup-repo-thelessone.unitConfig.RequiresMountsFor = "/moon";
      };
